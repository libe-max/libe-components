    ...
    return <blockquote className={classes.join(' ')}>
      <div className={`${c}__content`}>
        ...
        <div className={`${c}__decoration`}>
          <div className={`${c}__opening-quotation-mark`}><Svg src={`${staticsRootUrl}/assets/libe-opening-quotation-mark.svg`} /></div>
          <div className={`${c}__closing-quotation-mark`}><Svg src={`${staticsRootUrl}/assets/libe-closing-quotation-mark.svg`} /></div>
        </div>
      </div>
